 ...
 * @property {number} minScoreToCopy - Minimum wallet score to consider copying (default 50)
 * @property {number} minConfidence - Minimum confidence score to act (0-1, default 0.55)
 ...
 * @property {number} maxVolatilityForCopy - Max pool volatility for copy (default 7)
 * @property {number} minFeeTvlForCopy - Min fee/TVL ratio for copy (default 0.02)
 * @property {number} minOrganicForCopy - Min organic score for copy (default 70)
 * @property {number} organicConfidenceWeight - Organic confidence weight (default 0.15)
