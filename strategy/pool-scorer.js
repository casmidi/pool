...
export const DEFAULT_WEIGHTS = {
  ...
  organic_score:        18,   // Jupiter organic score — anti-wash, sustainable volume
  holders:               7,   // Token holder distribution
  token_age:             7,   // Older tokens = less rug risk, more price stability

  // === SMART MONEY / SOCIAL (15 pts) ===
  smart_money:          11,   // KOL clusters + smart money buy signal
  discord_signal:        6,   // Discord catalyst signal
